...
@section('content')
                    ...
                    <div class="col-xs-12" style="text-align:center;">
                        <div class="form-group">
                            ...
                            <a href="{{ url('/user') }}" class="btn btn-default btn-sm "><i class="fa fa-remove"></i>
                                Clear </a>
                            <a href="{{ route('admin_add_discount') }}" class="btn btn-info btn-sm"><i
    ...
    <section class="content appTuyenSinh">
            ...
            <form action="" method="post">
                ...
                <div class="double-scroll">
                    <table class="table table-bordered">
                        ...
                        @foreach ($discount as $l)
                            <tr>
                                {{-- <td><input type="checkbox" name="chk_hv[]" class="chk_hv" id="chk_hv_{{$item->id}}" value="{{$item->id}}"> </td> --}}
                                <td class="text-center">{{ $l->id }}</td>
                                <td class="text-center"><a style="color:#333333;font-weight: bold;" href=""
                                        style="white-space:unset;text-align: justify;"> {{ $l->title }} </a>
                                </td>
                                <td class="text-center"><a style="color:#333333;font-weight: bold;" href=""
                                        style="white-space:unset;text-align: justify;"> {{ $l->code }}</a>
                                </td>
                                <td class="text-center"><a style="color:#333333;font-weight: bold;" href=""
                                        style="white-space:unset;text-align: justify;"> {{ $l->discount }}.VNĐ </a>
                                </td>
                                <td class="text-center"><a style="color:#333333;font-weight: bold;" href=""
                                        style="white-space:unset;text-align: justify;"> {{ $l->start_time }}</a>
                                </td>
                                <td class="text-center"><a style="color:#333333;font-weight: bold;" href=""
                                        style="white-space:unset;text-align: justify;"> {{ $l->end_time }} </a>
                                </td>
        ...
        {{-- <div class="text-center">
            {{ $discount->appends($extParams)->links() }}
