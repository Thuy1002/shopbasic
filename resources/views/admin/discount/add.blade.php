...
@section('content')
    ...
    <section class="content appTuyenSinh">
        ...
        <form class="form-horizontal " action="{{route('admin_create_discount')}}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="box-body">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <label for="ten_de_thi" class="col-md-3 col-sm-4 control-label">Phần trăm giảm <span
                                    class="text-danger">(*)</span></label>
                        ...
                        <div class="form-group">
                            <label for="ten_de_thi" class="col-md-3 col-sm-4 control-label">Ngày bắt đầu<span
                                    class="text-danger">(*)</span></label>

                            <div class="col-md-9 col-sm-8">
                                <input type="date" name="start_time" id="" class="form-control"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9 col-sm-8">
                                <input type="date" name="end_time" id="" class="form-control"
