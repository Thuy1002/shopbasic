                    ...
                    <div class="aside">
                        ...
                        <div class="product-widget">
                            ...
                            <div class="product-body">
                                ...
                                <h4 class="product-price"> {{ number_format($product->discount_price) }}.VNĐ<del
                                        class="product-old-price">{{ number_format($product->price) }}.VND</del></h4>
                            </div>
                        </div>
                ...
                <div id="store" class="col-md-9">
                            ...
                            <label>
                                ...
                                <div>
                                    <button class="btn btn-success" onclick="location.href='{{ route('asc') }}'">Thấp đến
                                        cao</button>
                                    <button class="btn btn-primery" onclick="location.href='{{ route('desc') }}'">Cao đến
                                        thấp</button>
                                </div>
                            </label>
                        </div>
                                ...
                                <div class="product">
                                    ...
                                    <div class="product-body">
                                        ...
                                        <h4 class="product-price">{{ number_format($l->discount_price) }}VND<del
                                                class="product-old-price">{{ number_format($l->price) }}</del></h4>
                    ...
                    <div class="store-filter clearfix">
                        ...
                        <div style="text-align: center;">
                            {{ $Listsp->appends($extParams)->links() }}
                        </div>
