    ...
    <ul class="menu-nav">
        ...
        <li class="menu-item" aria-haspopup="true">
            <a target="" href="" class="menu-link">
                ...
                <span style="margin-left:10px;" class="menu-text"> Type Of Room</span>
            </a>
        </li>
        <li class="menu-item" aria-haspopup="true">
            <a target="" href="" class="menu-link">
                ...
                <span style="margin-left:10px;" class="menu-text"> Rooms</span>
            </a>
        </li>
        <li class="menu-item" aria-haspopup="true">
            <a target="" href="" class="menu-link">
                ...
                <span style="margin-left:10px;" class="menu-text"> Type Of Service</span>
            </a>
        </li>
        <li class="menu-item" aria-haspopup="true">
            <a target="" href="" class="menu-link">
                ...
                <span style="margin-left:10px;" class="menu-text">Services</span>
            </a>
        </li>
        <li class="menu-item" aria-haspopup="true">
            <a target="" href="" class="menu-link">
                ...
                <span style="margin-left:10px;" class="menu-text">Discount</span>
            </a>
        </li>
        <li class="menu-item" aria-haspopup="true">
            <a target="" href="" class="menu-link">
                ...
                <span style="margin-left:10px;" class="menu-text">Posts</span>
            </a>
        </li>
