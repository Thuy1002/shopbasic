                ...
                <ul class="sidebar-menu" data-widget="tree">
                    <li class=" active menu-open ">
                        ...
                        <ul class="treeview-menu">
                            <li><a href=" {{ route('route_BackEnd_Uesr_Index') }}"><i class="fa fa-circle-o"></i>Người
                                    dùng</a></li>
                        </ul>
                        <ul class="treeview-menu">
                            <li><a
                                    href="
                                {{ route('route_BackEnd_Danhmuc_Index') }}
                                "><i
                        ...
                        <ul class="treeview-menu">
                            <li><a
                                    href="
                                {{ route('route_BackEnd_Sanpham_Index') }}
                                "><i
                        ...
                        <ul class="treeview-menu">
                            <li><a
                                ...
                                "><i
                                        class="fa fa-circle-o"></i>Banners</a></li>
                        </ul>
                        <ul class="treeview-menu">
                            <li><a href="{{route('admin_discount')}}
                               
                                "><i
                                        class="fa fa-circle-o"></i>Discounts</a></li>
                        </ul>
                    </li>
                </ul>
            </section>
